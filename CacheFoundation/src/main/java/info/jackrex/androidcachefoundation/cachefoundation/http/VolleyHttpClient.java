...
public class VolleyHttpClient {
    ...
    public static String host = "";//demo replace yours
    ...
    public  void postWithParams(String url, Class clazz, List<BasicNameValuePair> params, Response.Listener listener,  Response.ErrorListener errorListener) throws UnsupportedEncodingException {

        GsonRequestEntity request = new GsonRequestEntity(Request.Method.POST, getAbsoluteUrl(url), clazz, null, params, listener, errorListener);
